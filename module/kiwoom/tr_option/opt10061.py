...
class Opt10061(KWTR):
    ...
    def __init__(self, core):
        ...
        self.rq_name = self.tr_code = 'opt10061'

        self.record_name_multiple = '종목별투자자기관별합계'
        self.header_multiple = [
            '개인투자자', '외국인투자자', '기관계', '금융투자', '보험', '투신', '기타금융', '은행', '연기금등', '사모펀드', '국가', '기타법인', '내외국인',
        ]


    def tr_opt(self, code, date_from, date_to, input3, input4, input5, prev_next, screen_no):
        # 종목코드 = 전문 조회할 종목코드
        ...
        self.core.set_input_value('금액수량구분', input3)
        self.core.set_input_value('매매구분', input4)
